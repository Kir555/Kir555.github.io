...
$('.changeContactsCity').click(function (e) {
  if (!$(this).hasClass('active')) {
    var lastValue = $('.changeContactsCity.active').attr('value');
    var newValue = $(this).attr('value');
    $('#' + lastValue + '-' + 'contacts').toggle();
    $('#' + newValue + '-' + 'contacts').toggle();
    $('.changeContactsCity').removeClass('active');
    $(this).addClass('active');
    $('#drop-cities-text').text(this.innerText);
    $("#contactsPosition").attr('value', newValue);
  }
});
